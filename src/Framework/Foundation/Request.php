...
use WebRover\Framework\Foundation\Exception\ConflictingHeadersException;
use WebRover\Framework\Foundation\Exception\SuspiciousOperationException;
...
class Request
{
    ...
    public function isMethodSafe(/* $andCacheable = true */)
    {
        if (!\func_num_args() || func_get_arg(0)) {
            ...
            @trigger_error('Checking only for cacheable HTTP methods with WebRover\Framework\Foundation\Request::isMethodSafe() is deprecated since Symfony 3.2 and will throw an exception in 4.0. Disable checking only for cacheable methods by calling the method with `false` as first argument or use the Request::isMethodCacheable() instead.', E_USER_DEPRECATED);
    ...
    private static function createRequestFromFactory(array $query = [], array $request = [], array $attributes = [], array $cookies = [], array $files = [], array $server = [], $content = null)
    {
        if (self::$requestFactory) {
            ...
            if (!$request instanceof self) {
                throw new \LogicException('The Request factory must return an instance of WebRover\Framework\Foundation\Request.');
            }
