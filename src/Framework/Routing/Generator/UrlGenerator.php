...
namespace WebRover\Framework\Routing\Generator;


use Psr\Log\LoggerInterface;
use WebRover\Framework\Routing\Exception\InvalidParameterException;
use WebRover\Framework\Routing\Exception\MissingMandatoryParametersException;
use WebRover\Framework\Routing\Exception\RouteNotFoundException;
 ...
 *
 * Class UrlGenerator
 * @package WebRover\Framework\Routing\Generator
 */
class UrlGenerator implements UrlGeneratorInterface, ConfigurableRequirementsInterface
{
    ...
    protected function doGenerate($variables, $defaults, $requirements, $tokens, $parameters, $name, $referenceType, $hostTokens, array $requiredSchemes = [])
    {
        ...
        // the contexts base URL is already encoded (see WebRover\Framework\Foundation\Request)
